  ...
  return (
    <div className={classes.root}>
      {positionInPlaylist === 'middle' || positionInPlaylist === 'end' ?
        ...
        >
          <svg className={classes.svg} viewBox="0 0 128 128" preserveAspectRatio="xMidYMid">
            <path d="M29.09 53.749V5.819H5.819v116.363h23.273v-47.93L122.18 128V0z" fill="currentColor"></path>
          </svg>
        </button>
      ...
      {play &&
        ...
        >
          <svg className={classes.svg} viewBox="0 0 128 128" preserveAspectRatio="xMidYMid">
            <path d="M41.86 128V0H8.648v128h33.21zm77.491 0V0h-33.21v128h33.21z" fill="currentColor"></path>
          </svg>
        </button>
      }
      {positionInPlaylist === 'middle' || positionInPlaylist === 'start' || positionInPlaylist === 'deleted' ?
        ...
        >
          <svg className={classes.svg} viewBox="0 0 128 128" preserveAspectRatio="xMidYMid">
            <path d="M98.91 53.749L5.817 0v128L98.91 74.251v47.93h23.273V5.819H98.909z" fill="currentColor"></path>
          </svg>
        </button>
      : <div style={{width:'16px'}}></div>}
    </div>
